---
title: Setup mail server using lightsail-miab-installer
date: 2024/08/12
description: lightsail-miab-installer is a user-friendly command-line tool designed to streamline the setup of [Mail-in-a-Box](https://mailinabox.email/) (a comprehensive mail server package) on Amazon Lightsail
tag: mail-server, linux
author: Rio Astamal
---
